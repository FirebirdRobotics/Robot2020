...
public class VisionSystem extends SubsystemBase {
  ...
  /*
   * NetworkTables is a collection of databases stored in the RoboRIO 
   * The coprocessor can change data inside of the rio 
   * This database can be viewed in a program called OutlineViewer
   */
  ...
  public VisionSystem() {
    ...
    // Configure limelight- http://docs.limelightvision.io/en/latest/networktables_api.html
  ...
  public void visionRoutineTape(Drivetrain drivetrain) {
    ...
    double m_distanceError = (VisionConstants.closestTargetArea - ta) * VisionConstants.kpDistance + VisionConstants.kConstantForce;
  ...
  public void updateLimelightTracking() {
    ...
    VisionConstants.closestTargetDistance = getClosestTargetDistance(VisionConstants.kTargetDistances, distanceToTarget(ty));
  ...
  public double distanceToTarget(double targetAngle) {
    ...
    return (VisionConstants.kTargetHeight - VisionConstants.kCameraHeight) / Math.tan(VisionConstants.kMountingAngle + targetAngle);
  }
